...
var file_user_server_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2f, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x66, 0x69,
	0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x19, 0x0a, 0x04, 0x75, 0x73,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52,
	0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x42, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50,
	...
	0x09, 0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x22, 0x32, 0x0a, 0x15, 0x55, 0x70, 0x64,
	...
	0x32, 0x05, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0x88, 0x01,
	...
	0x74, 0x65, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x15, 0x2e, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x16, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
...
var file_user_server_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_user_server_proto_goTypes = []interface{}{
	(*GetProfileResponse)(nil),    // 0: GetProfileResponse
	(*UpdateProfileRequest)(nil),  // 1: UpdateProfileRequest
	(*UpdateProfileResponse)(nil), // 2: UpdateProfileResponse
	(*User)(nil),                  // 3: User
	(*emptypb.Empty)(nil),         // 4: google.protobuf.Empty
}
var file_user_server_proto_depIdxs = []int32{
	3, // 0: GetProfileResponse.user:type_name -> User
	3, // 1: UpdateProfileResponse.user:type_name -> User
	4, // 2: UserService.GetProfile:input_type -> google.protobuf.Empty
	1, // 3: UserService.UpdateProfile:input_type -> UpdateProfileRequest
	0, // 4: UserService.GetProfile:output_type -> GetProfileResponse
	2, // 5: UserService.UpdateProfile:output_type -> UpdateProfileResponse
...
func file_user_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_user_server_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_server_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_user_server_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
