...
func (c *userServiceClient) GetProfile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetProfileResponse, error) {
...
func (UnimplementedUserServiceServer) GetProfile(context.Context, *emptypb.Empty) (*GetProfileResponse, error) {
